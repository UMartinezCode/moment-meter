...
**Goals** — daily / weekly / monthly time goals per category with progress bars; a green check marks a goal once it's met. Picking the category uses the same type-to-search box as the Log.
